     ...
     <div class="card-body">
       <form action="{{route('admin.shipping-rule.update', $shipping->id)}}" method="POST">
        ...
        <div class="form-group">
            <label>Name</label>
            <input name="name" value="{{$shipping->name}}" type="text" class="form-control">
        </div>
        ...
        <div class="form-group min_cost {{$shipping->type == 'min_cost' ? '' : 'd-none'}}">
            ...
            <input name="min_cost" value="{{$shipping->min_cost}}" type="text" class="form-control">
        </div>

        <div class="form-group">
            <label>Cost</label>
            <input name="cost" value="{{$shipping->cost}}" type="text" class="form-control">
        </div>
