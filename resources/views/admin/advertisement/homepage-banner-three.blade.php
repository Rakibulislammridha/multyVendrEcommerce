        ...
        <div class="card-body">
            <form action="{{route('admin.advertisement.homepage-banner-section-three')}}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" value="{{@$homepage_secion_banner_three->banner_one->banner_image}}" name="banner_one_old_image" class="form-control">
                </div>

                <div class="form-group">
                    <label>Banner URL</label>
                    <input type="text" value="{{@$homepage_secion_banner_three->banner_one->banner_url}}" name="banner_one_url" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" value="{{@$homepage_secion_banner_three->banner_two->banner_image}}" name="banner_two_old_image" class="form-control">
                </div>

                <div class="form-group">
                    <label>Banner URL</label>
                    <input type="text" value="{{@$homepage_secion_banner_three->banner_two->banner_url}}" name="banner_two_url" class="form-control">
                </div>
                ...
                <div class="form-group">
                    <img src="{{asset(@$homepage_secion_banner_three->banner_three->banner_image)}}" width="150px" alt="">
                </div>

                <div class="form-group">
                    <label>Banner Image</label>
                    <input type="file" value="" name="banner_three_image" class="form-control">
                    <input type="hidden" value="{{@$homepage_secion_banner_three->banner_three->banner_image}}" name="banner_three_old_image" class="form-control">
                </div>

                <div class="form-group">
                    <label>Banner URL</label>
                    <input type="text" value="{{@$homepage_secion_banner_three->banner_three->banner_url}}" name="banner_three_url" class="form-control">
                </div>
