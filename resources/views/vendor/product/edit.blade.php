      ...
      <div class="wsus__dashboard_profile">
       ...
       <form action="{{route('vendor.products.update', $product->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group wsus__input">
                    ...
                    <input name="offer_start_date" value="{{$product->offer_start_date}}" type="text" class="form-control datepicker">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group wsus__input">
                    <label>Offer End Date</label>
                    <input name="offer_end_date" value="{{$product->offer_end_date}}" type="text" class="form-control datepicker">
                </div>
            </div>
        </div>
        ...
        <div class="form-group wsus__input">
            ...
            <input name="qty" min="0" value="{{$product->qty}}" type="number" class="form-control">
        </div>
