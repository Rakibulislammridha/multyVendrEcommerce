                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            <form action="" method="" id="checkOutForm">
                        ...
                        <div class="wsus__check_form p-3">
                            <form action="{{route('user.checkout.address.create')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input name="state" type="text" placeholder="State *" value="{{old('state')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
    ...
    $(document).ready(function(){
        ...
        $('#submitCheckoutForm').on('click', function(e){
            ...
            if($('#shipping_method_id').val() == "") {
                toastr.error('Shiping Method is required!!');
            } else if($('#shipping_address_id').val() == ""){
                toastr.error('Shiping Address is required!!');
            } else if(!$('.agree_term').prop('checked')) {
                toastr.error('You have to aggree website terms and condition!!');
            } else {
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        /** Redirect user to next (payment) page **/
