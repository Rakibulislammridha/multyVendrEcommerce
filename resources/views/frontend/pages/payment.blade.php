                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-stripe" type="button" role="tab"
                                aria-controls="v-pills-stripe" aria-selected="false">stripe</button>

                                {{-- <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-razorpay" type="button" role="tab"
                        ...
                        <div class="tab-content" id="v-pills-tabContent" id="sticky_sidebar">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-paypal" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a href="{{route('user.paypal.payment')}}" class="text-center nav-link common_btn">Pay With Paypal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
