@php
    $categorySliderSectionThree = json_decode($categorySliderSectionThree->value, true);
@endphp

<section id="wsus__weekly_best" class="home2_wsus__weekly_best_2 ">
        <div class="container">
            <div class="row">
            @foreach ($categorySliderSectionThree as $sliderSectionThree)
            @php
                $lastKey = [];
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="wsus__section_header">
                    <h3>weekly best rated Products For {{$category->name}}</h3>
                </div>
