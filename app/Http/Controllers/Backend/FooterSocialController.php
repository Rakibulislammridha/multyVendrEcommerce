...
class FooterSocialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        toastr('Created Footer Social Successfully!!', 'success', 'Success');
    ...
    public function update(Request $request, string $id)
    {
        ...
        toastr('Updated Footer Social Successfully!!', 'success', 'Success');
    ...
    public function destroy(string $id)
    {
        ...
        return response(['status' => 'success', 'message' => 'Deleted Footer Social Successfully!!']);
    }
