...
class AdminListController extends Controller
{
    ...
    public function destroy(string $id)
    {
        ...
        if (count($products) > 0) {
            return response(['status' => 'error', 'message' => 'Admin can\'t be deleted you can banned the admin insted of delete cause this admin have products!!']);
        }
    ...
    public function changeStatus(Request $request)
    {
        ...
        return response(['message' => 'Admin Status Has Been Updated!']);
    }
}